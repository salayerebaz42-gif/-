...
# دمج TF-IDF + LDA
X_train_vec = hstack([X_train_tfidf, csr_matrix(X_train_lda)])
X_test_vec  = hstack([X_test_tfidf,  csr_matrix(X_test_lda)])
